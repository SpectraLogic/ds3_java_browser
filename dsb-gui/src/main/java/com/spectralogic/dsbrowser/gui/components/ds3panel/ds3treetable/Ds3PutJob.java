...
public class Ds3PutJob extends Ds3JobTask {
    ...
    public Ds3PutJob(final Ds3Client client, final List<File> files, final String bucket, final String targetDir, final DeepStorageBrowserPresenter deepStorageBrowserPresenter, final String jobPriority, final int maximumNumberOfParallelThreads, final JobInterruptionStore jobIdsModel, Ds3Common ds3Common) {
        this.client = client;
        this.files = files;
        this.bucket = bucket;
    ...
    private String getDs3ObjectPath(Path key, Path value, boolean contains, int fileCount, int dirCount) {
        String ds3ObjPath;
        if (fileCount == 0) {
