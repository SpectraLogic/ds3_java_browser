...
public class GetJobPriorityTaskTest {
    ...
    private final LazyAlert lazyAlert = new LazyAlert(resourceBundle);
    private final CreateConnectionTask createConnectionTask = new CreateConnectionTask(lazyAlert, resourceBundle, buildInfoService);
